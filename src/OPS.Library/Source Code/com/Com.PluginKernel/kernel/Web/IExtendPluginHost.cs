...
namespace Com.PluginKernel.Web
{
    ...
    public interface IExtendPluginHost : IPluginHost
    {
        ...
        void ExtendModuleRequest(HttpContext context, string extendName, ref bool result);
        ...
        /// <param name="extendName"></param>
        /// <param name="result"></param>
        void ExtendModulePost(HttpContext context, string extendName, ref bool result);
