...
namespace AtNet.DevFw.Framework.Extensions
{
    public static class HttpExtensions
    {
        ...
        /// <returns></returns>
        public static bool IsSplider(this HttpRequest request)
        {
            string[] botNames = new string[]
            {
                ...
                "YodaoBot", //有道蜘蛛
                "YoudaoBot", //有道蜘蛛
                "Sogou Web Sprider" //搜狗蜘蛛
            };

            string agent = request.UserAgent;
            bool isSplider = false;
            Array.ForEach(botNames, a => { if (agent.IndexOf(a) != -1) isSplider = true; });
            return isSplider;
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public static bool IscMobileDevice(this HttpRequest request)
        {
