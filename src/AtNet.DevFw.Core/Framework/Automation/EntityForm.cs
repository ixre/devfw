...
namespace AtNet.DevFw.Framework.Automation
{
    /// <summary>
    /// 实体表单
    /// </summary>
                    ...
                    else
                    {
                        ...
                        if (!ffa.DisableEdit)
                        {
                            ...
                            if (sfAttrs.Length != 0)
                            {
                                ...
                                if (sfa.UseDrop)
                                {
                                    sb.Append("<select class=\"ui-validate\" field=\"")
                                        .Append(ffa.Name)
                                        .Append("\" name=\"field_")
                                        .Append(ffa.Name)
                                        .Append("\"");
                            ...
                            else
                            {
                                ...
                                {
                                    //输出Textbox
                                    sb.Append("<textarea class=\"ui-validate\" field=\"")
                                        .Append(ffa.Name)
                                        .Append("\" name=\"field_")
                                        .Append(ffa.Name)
                                        .Append("\"");
                                ...
                                {
                                    //输出INPUT
                                    sb.Append("<input class=\"ui-validate\" type=\"")
