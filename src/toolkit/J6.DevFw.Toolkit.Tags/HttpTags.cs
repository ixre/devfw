...
namespace JR.DevFw.Toolkit.Tags
{
    public class HttpTags
    {
        ...
        /// 默认的配置路径
        /// </summary>
        private static string defaultConfigPath = AppDomain.CurrentDomain.BaseDirectory + "config/tags.conf";
