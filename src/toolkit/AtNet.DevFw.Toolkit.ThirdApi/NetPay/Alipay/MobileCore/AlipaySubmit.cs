...
using System.Text;
using System.Xml;
using AtNet.DevFw.Toolkit.ThirdApi.NetPay.Alipay.Core;

namespace AtNet.DevFw.Toolkit.ThirdApi.NetPay.Alipay.MobileCore
{
    /// <summary>
    /// 类名：Submit
    /// 功能：支付宝各接口请求提交类
    ...
    public class Submit
    {
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            {
                case "MD5":
                    mysign = AlipayMD5.Sign(prestr, AlipayMobileConfig.Key, AlipayMobileConfig.Input_charset);
                    break;
                case "RSA":
                    mysign = RSAFromPkcs8.sign(prestr, AlipayMobileConfig.Private_key, AlipayMobileConfig.Input_charset);
                    break;
                case "0001":
                    mysign = RSAFromPkcs8.sign(prestr, AlipayMobileConfig.Private_key, AlipayMobileConfig.Input_charset);
                    break;
        ...
        private static Dictionary<string, string> BuildRequestPara(Dictionary<string, string> sParaTemp)
        {
            ...
            {
                sPara.Add("sign_type", AlipayMobileConfig.Sign_type);
            }
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            sbHtml.Append("<form id='alipaysubmit' name='alipaysubmit' action='" + GATEWAY_NEW + "_input_charset=" + AlipayMobileConfig.Input_charset + "' method='" + strMethod.ToLower().Trim() + "'>");
        ...
        {
            Encoding code = Encoding.GetEncoding(AlipayMobileConfig.Input_charset);
            ...
            //构造请求地址
            string strUrl = GATEWAY_NEW + "_input_charset=" + AlipayMobileConfig.Input_charset;
        ...
        public static Dictionary<string, string> ParseResponse(string strText)
        {
            ...
            if (dicText["res_data"] != null)
            {
                ...
                {
                    dicText["res_data"] = RSAFromPkcs8.decryptData(dicText["res_data"], AlipayMobileConfig.Private_key, AlipayMobileConfig.Input_charset);
                }
        ...
        public static string Query_timestamp()
        {
            ...
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayMobileConfig.Partner + "&_input_charset=" + AlipayMobileConfig.Input_charset;
            string encrypt_key = "";
