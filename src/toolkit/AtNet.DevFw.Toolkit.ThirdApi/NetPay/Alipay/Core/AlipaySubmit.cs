...
namespace AtNet.DevFw.Toolkit.ThirdApi.NetPay.Alipay.Core
{
    /// <summary>
    /// 类名：Submit
    /// 功能：支付宝各接口请求提交类
    ...
    public class Submit
    {
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            sbHtml.Append("<form id='alipaysubmit' name='alipaysubmit' action='" + GATEWAY_NEW + "_input_charset=" + AlipayConfig.Input_charset + "' method='" + strMethod.ToLower().Trim() + "'>");
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //构造请求地址
            string strUrl = GATEWAY_NEW + "_input_charset=" + AlipayConfig.Input_charset;
