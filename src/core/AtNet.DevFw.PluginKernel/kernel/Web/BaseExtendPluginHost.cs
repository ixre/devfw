...
namespace AtNet.DevFw.PluginKernel.Web
{
    ...
    public abstract class BaseExtendPluginHost : BasePluginHost, IExtendPluginHost
    {
        ...
        public virtual void ExtendModuleRequest(HttpContext context, string extendName, ref bool result)
        {
        ...
        /// <param name="tag"></param>
        /// <param name="page"></param>
        public virtual void ExtendModulePost(HttpContext context, string extendName, ref bool result)
        {
            extendName = extendName.ToLower();
