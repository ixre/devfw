...
namespace J6.DevFw.Web.Plugin
{
    ...
    internal class WebPluginApp : BaseWebPluginHost, IPluginApp
    {
        ...
        internal WebPluginApp(WebPluginHandleProxy<HttpContext> webHandler)
            : base(webHandler)
        {
        ...
        private void RegisterRoute()
        {
            ...
            if (FwCtx.Mono())
            {
                ...
                routes.Add("plugin_mono_h", new Route("{plugin}.h", pluginHandler));
                routes.Add("plugin_mono_aspx", new Route("{plugin}.h.aspx", pluginHandler));
            }
        ...
        public override void HttpPluginRequest(HttpContext context, string pluginName, ref bool result)
        {
        ...
        /// <param name="result"></param>
        public override void HttpPluginPost(HttpContext context, string extendName, ref bool result)
        {
