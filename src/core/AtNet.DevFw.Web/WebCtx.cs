...
using AtNet.DevFw.Web.Cache;
using AtNet.DevFw.Web.Cache.Compoment;
...
namespace AtNet.DevFw.Web
{
    ...
    public class WebCtx
    {
        ...
        private static IExtendApp _extends;
        ...
        /// 插件扩展
        /// </summary>
        public static IExtendApp Extend
        {
            get
            {
                if (_extends == null)
...
//        }
        ...
        public void Render(string html)
        {
            ...
            response.AddHeader("X-AspNet-Version", String.Format("atnet.devfw - v{0}", FwCtx.Version.GetVersion()));
            response.AddHeader("Support-URL", "github.com/atnet/devfw");
        }
