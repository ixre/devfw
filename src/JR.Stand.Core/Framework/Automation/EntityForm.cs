...
using CollectionExtensions = JR.DevFw.Framework.Extensions.CollectionExtensions;
using HttpContext = JR.Stand.Core.Framework.Web.HttpContext;

namespace JR.DevFw.Framework.Automation
{
    /// <summary>
    /// 实体表单
    /// </summary>
